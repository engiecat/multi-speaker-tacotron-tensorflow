...
from text.symbols import symbols, en_symbols, en_symbols_arpabet, PAD, EOS
...
'''
	...
	if not isEn:
		...
		if hparams.use_cmudict:
			print(" [!] Using CMUDict - include arpabet")
			_symbol_to_id = {s: i for i, s in enumerate(en_symbols_arpabet)}
			_id_to_symbol = {i: s for i, s in enumerate(en_symbols_arpabet)}
		else:
